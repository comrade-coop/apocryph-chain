...
//                 Console.WriteLine("Got gossip, {0} -- {1}", string.Join(":", _committer!.GetConfirmations(gossip.Value, GossipVerb.Reject, nodes)), string.Join(":", _committer!.GetConfirmations(gossip.Value, GossipVerb.Confirm, nodes)));
