using Apocryph.Agents.AgentZero.Messages;
using Apocryph.Agents.AgentZero.State;

namespace Apocryph.Agents.AgentZero
{
    public class AgentZeroState
    {
        public Dictionary<Guid, Balance> Balances { get; set; } = new();
        public Dictionary<Guid, Chain> Chains { get; set; } = new ();
        public Dictionary<(Guid, Guid), Balance> Tickets { get; set; } = new();
